...
const About = () => {
  return (
    <div className="min-h-screen bg-gradient-charcoal">
      <Navigation />
      
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12" data-aos="fade-up">
          <h1 className="text-4xl font-bold text-white mb-4">Sobre o Minha Persona</h1>
        ...
        <div className="space-y-8">
          <Card className="p-8 bg-gradient-glass backdrop-blur-sm border-white/20 shadow-lg text-white" data-aos="fade-up" data-aos-delay="100">
          ...
          <Card className="p-8 bg-gradient-glass backdrop-blur-sm border-white/20 shadow-lg text-white" data-aos="fade-up" data-aos-delay="200">
            <h2 className="text-2xl font-bold text-white mb-4">Como Surgiu</h2>
          ...
          <Card className="p-8 bg-gradient-glass backdrop-blur-sm border-white/20 shadow-lg text-white" data-aos="fade-up" data-aos-delay="300">
            <h2 className="text-2xl font-bold text-white mb-4">Nossa Tecnologia</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-6">
              ...
              <div className="bg-gradient-noir/50 p-6 rounded-lg border border-white/20">
                <h3 className="font-semibold text-white mb-2">⚡ Velocidade</h3>
                <p className="text-gray-300 text-sm">
          ...
          <Card className="p-8 bg-gradient-glass backdrop-blur-sm border-white/20 shadow-lg text-white" data-aos="fade-up" data-aos-delay="400">
            <h2 className="text-2xl font-bold text-white mb-4">Para Quem é o Minha Persona</h2>
