        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/generator" className="text-gray-400 hover:text-white transition-colors">Gerar Persona</a></li>
