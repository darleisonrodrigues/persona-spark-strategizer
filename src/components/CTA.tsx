      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        <Card className="p-12 md:p-16 bg-gradient-glass backdrop-blur-xl border-white/30 shadow-2xl" data-aos="zoom-in">
          ...
          <div className="flex justify-center mb-8">
            <Button 
              size="lg" 
              className="bg-white text-slate-700 hover:bg-slate-50 font-bold px-10 py-5 text-xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105"
