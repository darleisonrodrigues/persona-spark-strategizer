  ...
  return (
    <section className="py-20 bg-gradient-primary">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <Card className="p-8 md:p-12 bg-white/10 backdrop-blur-sm border-white/20" data-aos="zoom-in">
          ...
          <div className="flex justify-center">
            <Button 
              size="lg" 
              className="bg-white text-slate-700 hover:bg-slate-50 font-semibold px-8 py-4 text-lg shadow-lg"
